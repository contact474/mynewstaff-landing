...
const NAV_ITEMS: NavItem[] = [
  ...
  { label: "Brooke AI", href: "/app/brooke", icon: <IconBrooke /> },
  { label: "AI Advisor", href: "/app/advisor", icon: <IconAdvisor /> },
  ...
  { label: "Proposals", href: "/app/proposals", icon: <IconPlaybooks /> },
