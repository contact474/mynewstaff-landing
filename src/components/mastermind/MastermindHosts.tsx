...
const HOSTS: Host[] = [
  {
    ...
    bio: "Built the autonomous AI stack that runs MNS — cold callers, content engines, ad systems, and lead machines that operate without humans in the loop. Slovenian Government COVID partnership: saved 50% of taxpayer money, 100% campaign success rate. His clients generated $1.1M+ each this year using the same systems you'll get deployed in the mastermind.",
    gradient:
  ...
  },
  {
    ...
    name: "Yeram",
    handle: "@yeram",
    role: "Mindset Architect · Performance Coach",
    bio: "Mindset coaching and clinical hypnotherapy for high-performers making big operational shifts. When you go from manual to AI-automated, the biggest blocker isn't the tech — it's your identity. Yeram helps you integrate the upgrade so you don't self-sabotage the transformation. Included in Builder and Partner tiers.",
    gradient:
...
export function MastermindHosts() {
  return (
      ...
      <Reveal>
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-wide font-bold uppercase tracking-tighter leading-[0.95]">
            The builder.
            <br />
            <span className="shimmer-text">The mindset architect.</span>
          </h2>
        </div>
      </Reveal>
