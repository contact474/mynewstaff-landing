      ...
      <div className="z-10 relative px-4 max-w-4xl mb-24 md:mb-32">
        <Reveal>
          <span className="block text-xs md:text-sm tracking-[0.25em] mb-6 text-white/50 font-wide shimmer-text">
            ONLINE MASTERMIND — LIVE · 5 SEATS · COPY TRADE LEADERS ONLY
          </span>
        </Reveal>
        <Reveal delay={0.15}>
          <h1 className="text-4xl md:text-7xl lg:text-8xl font-wide font-bold leading-[0.95] md:leading-[0.85] tracking-tighter uppercase">
            WE AUTOMATE.
            <br />
            <span className="shimmer-text">YOU SCALE.</span>
          </h1>
        </Reveal>
        <Reveal delay={0.35}>
          <p className="mt-8 text-sm md:text-base text-zinc-400 max-w-xl mx-auto leading-relaxed font-sans">
            Your copy trade strategy is already printing. Your IB program
            is already earning. But the business around it — client acquisition,
            content, onboarding, recruitment — is still manual.
            We install the same AI infrastructure that generated $1.1M+ per
            client this year. Live on your operation. In one session.
          </p>
        </Reveal>
        <Reveal delay={0.5}>
