    ...
    return (
      <main className="min-h-screen bg-black text-white flex items-center justify-center px-4">
        <div className="w-full max-w-sm text-center">
          <div className="w-12 h-12 border border-emerald-500/30 rounded-full flex items-center justify-center mx-auto mb-6">
            <svg className="w-5 h-5 text-emerald-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
            </svg>
          </div>
          <h2 className="text-xl font-wide font-bold uppercase mb-3">Check Your Email</h2>
          ...
          <Link
            href="/login"
            className="inline-block px-8 py-3 border border-white/20 text-[10px] tracking-[0.25em] uppercase font-bold hover:bg-white/[0.03] transition-all"
          >
            Back to Login
          </Link>
        </div>
    ...
    <main className="min-h-screen bg-black text-white flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-2xl font-wide font-bold uppercase">Create Account</h1>
          <p className="text-xs text-zinc-500 font-sans mt-3">
            Free diagnostic included. Upgrade anytime.
          </p>
        </div>
        ...
        <form onSubmit={handleSignup} className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-[10px] tracking-[0.2em] uppercase text-zinc-500 mb-2">Name</label>
              <input
                type="text"
                value={fullName}
            ...
            <div>
              <label className="block text-[10px] tracking-[0.2em] uppercase text-zinc-500 mb-2">Company</label>
              <input
                type="text"
                value={companyName}
