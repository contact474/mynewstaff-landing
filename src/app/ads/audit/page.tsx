 ...
 *
 * Same proven design as /audit, but:
 * - NO navbar (zero exit points for ad traffic)
 * - NO sticky nav (keep them on page)
 * - Added social proof bar at top
 * - Message-matched headline for ad copy
 * - All same components = guaranteed CSS works
 */
...
export default function AdsAudit() {
    return (
        <main className="min-h-screen relative !overflow-visible bg-black text-white selection:bg-white selection:text-black">
            ...
            {/* Social proof bar — builds instant trust for ad traffic */}
            <div className="w-full border-b border-white/5 py-3 px-4">
                <div className="max-w-[900px] mx-auto flex items-center justify-center gap-6 md:gap-10 flex-wrap">
                    <span className="text-[9px] md:text-[10px] tracking-[0.25em] uppercase text-white/40 font-sans">500+ audits delivered</span>
                    <span className="hidden md:inline text-white/10">·</span>
                    <span className="text-[9px] md:text-[10px] tracking-[0.25em] uppercase text-white/40 font-sans">Avg 3.2x lead increase</span>
                    <span className="hidden md:inline text-white/10">·</span>
                    <span className="text-[9px] md:text-[10px] tracking-[0.25em] uppercase text-white/40 font-sans">Results in &lt; 5 min</span>
                </div>
            </div>
                ...
                <div className="z-10 relative px-4 max-w-[900px]">
                    ...
                    <Reveal delay={0.15}>
                        <h1 className="text-4xl md:text-7xl lg:text-8xl font-wide font-bold leading-[0.95] md:leading-[0.85] tracking-tighter uppercase">
                            SEE WHERE AI<br /> CAN <span className="shimmer-text">3X YOUR</span><br /> MARKETING
                        </h1>
                    </Reveal>
                    <Reveal delay={0.3}>
                    ...
                    <Reveal delay={0.45}>
                        <a href="#get-audit" className="inline-block mt-10 px-10 py-4 bg-white text-black font-bold text-[11px] tracking-[0.25em] uppercase font-sans hover:bg-white/90 transition-all duration-300">
                            Get Your Free Audit
                        </a>
                    </Reveal>
                    <Reveal delay={0.55}>
            ...
            {/* Final CTA — no nav links, just trust + CTA */}
